  ...
  return (
    <div>
      <header
        ...
        <div className="relative text-center animate-pulse top-0">
          <h1 className=" bg-red-700 text-700 font-first text-xl">
            This website just a copy of my work you can see origin website{" "}
            <a className="underline text-blue-300" href="https://tecvity.co" target="blank">
              Tecvity.co
            </a>
          </h1>
        </div>
